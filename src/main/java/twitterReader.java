public class twitterReader {
    ...
    public static String[] getTopics(String testmsg) {
        ...
        String[] TopicList = new String[20];
        ...
        for(int i=0;i<message.length;i++){
            ...
            // if the word matches our regex to check for topics(see above), return it
            if(message[i].matches(regex)){
                TopicList[TopicCount] = message[i];
                TopicCount++;
            }
        }
        System.out.println(TopicCount + "Topics found");
        // otherwise return null list? to indicate no links were found
        return TopicList;
    }

    public static String[] getMentions(String testmsg) {
        ...
        String[] MentionList = new String[20];
        ...
        for(int i=0;i<message.length;i++){
            ...
            if(message[i].matches(regex)){
                MentionList[Mentioncount] = message[i];
                Mentioncount++;
            }
        }

        System.out.println(Mentioncount + "Mentions found");
